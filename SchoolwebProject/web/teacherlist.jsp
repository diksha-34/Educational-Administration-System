     ...
     <section class="inner-banner py-5">
        <div class="w3l-breadcrumb py-lg-5">
            <div class="container pt-4 pb-sm-4">
                <h4 class="inner-text-title pt-5">Teacher List</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="index.html">Home</a></li>
                    <li class="active"><i class="fas fa-angle-right"></i>Teachers</li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            <form method="get">
               <div class="form-group">
                    <label class="col-form-label" ><h1>Subject</h1>
                                </label>
...
if (request.getParameter("submit") != null) {
    String selectedsubject = request.getParameter("sub");
    if (selectedsubject != null && !selectedsubject.isEmpty()) {
        try {
            ...
            mystatement.setString(1, selectedsubject);
          session.setAttribute("subject",selectedsubject);
            ...
            if (myresult.next()) {
                ...
                do {
                    out.print("<tr><td>" + myresult.getString("name1") + "</td><td>"
                            ...
                            + "<td><a href=deleteteach.jsp?teachid=" + myresult.getString("teachid") + "><img src='assets/images/delete.png'></a></td>"
                            + "</tr>");
                } while (myresult.next());

                 
            } else {
                out.print("<div>No records found for Subject " + selectedsubject + "</div>");
            }
        } catch (Exception e) {
            out.print("Error in query or connection: " + e.getMessage());
        }
  ...
  <script type="text/javascript">
        $(document).ready(function () {
            $("#subject").change(function () {
                ...
                var subject1 = $(this).val(); // Use $(this) to refer to the element that triggered the event
                $.ajax({
                    method: "POST",
                    url: "myajax.jsp",
