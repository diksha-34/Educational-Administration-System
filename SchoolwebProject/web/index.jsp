...
<head>
    ...
    <title>Welcome to Edu School Website</title>
    <!-- Google fonts -->
                ...
                <div class="row align-items-center pt-sm-5 pt-4">
                    <div class="col-md-6">
                        ...
                        <div class="d-flex align-items-center buttons-banner">
                            <a href="contact.jsp" class="btn btn-style mt-lg-5 mt-4">Admission Now</a>
                        </div>
                    </div>
            ...
            <div class="row content23-col-2 text-center">
                <div class="col-md-6">
                    <div class="content23-grid content23-grid1">
                        <h4><a href="about.jsp">Expert Teachers</a></h4>
                    </div>
                </div>
                <div class="col-md-6 mt-md-0 mt-4">
                    <div class="content23-grid content23-grid2">
                        <h4><a href="about.jsp">Safe Environment</a></h4>
                    </div>
                </div>
            </div>
        </div>
