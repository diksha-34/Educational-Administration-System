...
<head>
    <title>Edu School - feesadd</title>
    <!-- Meta tag Keywords -->
     ...
     <section class="inner-banner py-5">
        <div class="w3l-breadcrumb py-lg-5">
            <div class="container pt-4 pb-sm-4">
                <h4 class="inner-text-title pt-5">Student Fees</h4>
    ...
    <section class="w3l-contact py-5" id="contact">
            ...
            if(request.getParameter("submit")!=null || request.getParameter("rollno")!=null){
                ...
                transportation_charges=request.getParameter("tcharges");
                    ...
                    try{
                        ...
                        try{
                            PreparedStatement mystatement = myConnection.prepareStatement("insert into fees (`studentid`, `rollno`, `total_amount`, `installment1`, `installment1_date`, `installment2`, `installment2_date`, `installment3`, `installment3_date`, `installment4`, `installment4_date`, `tcharges`,`Remaining_amount`) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)");
                            ...
                            if(mystatement.executeUpdate()>0){
                                out.print("<label class='col-form-label'>Fees added Succesfully.</label>");
                            }
        ...
        %>
                        ...
                        <%
                                ...
                                Connection myConnection=DriverManager.getConnection(PATH+PLACE, USERNAME, PASSWORD);
                                    try{
                                    PreparedStatement mystatement = myConnection.prepareStatement("select rollno from student");
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Remaining amount" name="remain" required="">
                    </div>
                            
                   <div class="text-start">
                    <button name="submit" class="btn btn-style btn-style-3" >Add Student's fees details</button>
                   </div>
                </form>
