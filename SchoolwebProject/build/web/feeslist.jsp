        ...
        <div class="row">
            <form method="get">
                <div class="form-group">
                        <select name="sid" class="form-control" id="stuuid">
                        ...
                        <%
                                ...
                                Connection myConnection=DriverManager.getConnection(PATH+PLACE, USERNAME, PASSWORD);
                                    try{
                                    PreparedStatement mystatement = myConnection.prepareStatement("select studentid from fees");
  ...
  <%@include file="footer.jsp" %>
   <script type="text/javascript">
        $(document).ready(function () {
            $("#stuuid").change(function () {
                

                var stuuid1 = $(this).val();
                $.ajax({
                    method: "POST",
                    url: "myajax.jsp",
                    data: { studentid: stuuid1 }
                }).done(function (msg) {
                    $("#resultbox").html(msg);
                });
            });
